...
function loadI2b2Data {
    ...
    cat > db.properties <<EOL
        db.type=postgresql
        db.username=i2b2demodata_i2b2
        db.password=$I2B2_DB_PASSWORD
        db.driver=org.postgresql.Driver
        db.url=jdbc:postgresql://localhost/$DB_NAME?searchpath=i2b2demodata_i2b2
        db.project=demo
EOL
    ...
    cat > db.properties <<EOL
        ...
        db.password=$I2B2_DB_PASSWORD
        db.driver=org.postgresql.Driver
        db.url=jdbc:postgresql://localhost/$DB_NAME?searchpath=i2b2hive
EOL
    ...
    cat > db.properties <<EOL
        ...
        db.password=$I2B2_DB_PASSWORD
        db.driver=org.postgresql.Driver
        db.url=jdbc:postgresql://localhost/$DB_NAME?searchpath=i2b2imdata
        db.project=demo
EOL
    ...
    cat > db.properties <<EOL
        db.type=postgresql
        db.username=i2b2metadata_i2b2
        db.password=$I2B2_DB_PASSWORD
        db.driver=org.postgresql.Driver
        db.url=jdbc:postgresql://localhost/$DB_NAME?searchpath=i2b2metadata_i2b2
        db.project=demo
EOL
    ...
    cat > db.properties <<EOL
        ...
        db.password=$I2B2_DB_PASSWORD
        db.driver=org.postgresql.Driver
        db.url=jdbc:postgresql://localhost/$DB_NAME?searchpath=i2b2pm
EOL
    ...
    cat > db.properties <<EOL
        ...
        db.password=$I2B2_DB_PASSWORD
        db.driver=org.postgresql.Driver
        db.url=jdbc:postgresql://localhost/$DB_NAME?searchpath=i2b2workdata
        db.project=demo
EOL
