-- todo: create a plsql function with parameters to load each type of resource

BEGIN;
	DO $$
	DECLARE
      -- Set the resource parameters
    resourceName varchar := 'i2b2-local';

    resourceURL varchar := 'http://wildfly-server:8080/i2b2/services/';
    transmartURL varchar := '';
    auth0ClientId varchar := '';
    auth0Domain varchar := '';

    domain varchar := 'i2b2demo';
    ...
    -- Set the Fields
    --encounter_ContainsId integer := (select COALESCE(max(id), 0) from IRCT_Field) + 1;

    modifier_FieldId integer := (select COALESCE(max(id), 0) from IRCT_Field) + 1;
    --encounter_ModifierId integer := modifier_FieldId + 1;
    ...
    --encounter_ConstrainValueId integer := unitOfMeasure_ConstrainValueId + 1;
    ...
    --encounter_ConstrainDateId integer := toDate_ConstrainDateId + 1;
	BEGIN
    -- INSERT THE RESOURCE
    ...
    insert into IRCT_resource_parameters(id, name, value) values(resourceId, 'domain', domain);
    ...
    --insert into IRCT_Field(id, description, name, path, relationship, required) values(encounter_ContainsId, 'By Encounter', 'By Encounter', 'ENCOUNTER', null, true);
    --insert into IRCT_Field_permittedValues(Field_Id, permittedValues) values(encounter_ContainsId, 'YES');
    --insert into IRCT_Field_permittedValues(Field_Id, permittedValues) values(encounter_ContainsId, 'NO');

    --insert into IRCT_PredicateType_Field(PredicateType_id, fields_id) values(containsId, encounter_ContainsId);
    ...
    --insert into IRCT_Field(id, description, name, path, relationship, required) values(encounter_ModifierId, 'By Encounter', 'By Encounter', 'ENCOUNTER', null, true);
    --insert into IRCT_Field_permittedValues(Field_Id, permittedValues) values(encounter_ModifierId, 'YES');
    --insert into IRCT_Field_permittedValues(Field_Id, permittedValues) values(encounter_ModifierId, 'NO');

    insert into IRCT_PredicateType_Field(PredicateType_id, fields_id) values(constrainModifierId, modifier_FieldId);
    --insert into IRCT_PredicateType_Field(PredicateType_id, fields_id) values(constrainModifierId, encounter_ModifierId);
    ...
    --insert into IRCT_Field(id, description, name, path, relationship, required) values(encounter_ConstrainValueId, 'By Encounter', 'By Encounter', 'ENCOUNTER', null, true);
    --insert into IRCT_Field_permittedValues(Field_Id, permittedValues) values(encounter_ConstrainValueId, 'YES');
    --insert into IRCT_Field_permittedValues(Field_Id, permittedValues) values(encounter_ConstrainValueId, 'NO');
    ...
    --insert into IRCT_PredicateType_Field(PredicateType_id, fields_id) values(constrainValueId, encounter_ConstrainValueId);
    ...
    --insert into IRCT_Field(id, description, name, path, relationship, required) values(encounter_ConstrainDateId, 'By Encounter', 'By Encounter', 'ENCOUNTER', null, true);
    --insert into IRCT_Field_permittedValues(Field_Id, permittedValues) values(encounter_ConstrainDateId, 'YES');
    --insert into IRCT_Field_permittedValues(Field_Id, permittedValues) values(encounter_ConstrainDateId, 'NO');
    ...
    --insert into IRCT_PredicateType_Field(PredicateType_id, fields_id) values(constrainDateId, encounter_ConstrainDateId);
